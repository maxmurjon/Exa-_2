...
type ExamRepoI interface {
	...
	GetList(ctx context.Context, req *models.GetListBrandRequest) (resp *models.GetListPromocodeResponse, err error)
	Delete(ctx context.Context, req *models.PromocodePrimaryKey) (int64, error)
	TotalSumm(ctx context.Context, req *models.OrderItemPrimaryKey) (float64, error)
	Report(ctx context.Context, req *models.Date) (res []models.StaffDate, err error)
